        ...
        <div className="hero flex flex-col lg:flex-row justify-between px-5 lg:px-20 pt-20">
            <div className="left lg:w-2/5 xl:w-40%">
                ...
                <div className="btn mt-5">
                    <button className='px-5 py-2 lg:px-4 lg:py-1 md:px-3 md:py-1 border-2 border-green-900 rounded-xl font-medium xl:text-xl lg:text-lg bg-green-900 text-white hover:cursor-pointer hover:bg-green-950 hover:border-green-950 transition' onClick={handleHomeDeliveryClick}>Home Delivery</button>
